...
public class AssetsViejo {
    ...
    public static final CustomAnimation heart = new CustomAnimation("slimeboi/resources/JerrySpriteSheet.png", 1, 0, 26, DEFAULT_ANIMATION_WIDTH, DEFAULT_ANIMATION_HEIGHT, 15, true);
    public static final CustomAnimation hurtHeart = new CustomAnimation("slimeboi/resources/JerrySpriteSheet.png", 4, 6, 26, DEFAULT_ANIMATION_WIDTH, DEFAULT_ANIMATION_HEIGHT, 15, true);
    //Jerry//
