...
public class AssetsViejo {
    ...
    public static final CustomAnimation thunderShotR = new CustomAnimation("slimeboi/resources/ThunderBeam.png", 13, 0, 0, 1832, 64, 16, true);
    public static final CustomAnimation thunderShotL = new CustomAnimation("slimeboi/resources/ThunderBeamLeft.png", 13, 0, 0, 1832, 64, 16, true);
